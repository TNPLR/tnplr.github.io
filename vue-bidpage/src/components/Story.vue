        ...
        return {
            ...
            allStories: {
                '開叫': [
                    ...
                    {spades: 'J7', hearts: 'AT9753', diamonds: 'T63', clubs: 'K7', auction: ['1C', 'P', '1H', 'P'], correct: '2H', answers: {'2H': '正確。這是竄叫，詳細可參考234定律。', }},
                    {spades: 'J3', hearts: 'JT9754', diamonds: 'KJ32', clubs: '9', auction: ['1C', 'P', '1H', 'P'], correct: 'Pass', answers: {'2H': '錯誤。牌組品質和點力都有點糟，除非特別約定過，否則不要竄叫', }},
                    {spades: '62', hearts: 'KT9652', diamonds: 'J83', clubs: 'K8', auction: ['1C', 'P', '1H', 'P'], correct: '2H', answers: {'2H': '正確。點力適合，牌組不差，可以竄叫', }},
                    {spades: '86', hearts: 'KQJ532', diamonds: 'A6', clubs: 'T75', auction: ['1C', 'P', '1H', 'P'], correct: '1H', answers: {'1H': '正確。雖然點力沒有到12點，但紅心牌組很好，所以可以開叫', }},
                ],
                '低花開叫的答叫': [
