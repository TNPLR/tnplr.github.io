    ...
    <article ref="Article">
        ...
        <div><h2>低花開叫的後續</h2>
            ...
            <div><h3>反序低花</h3>
                ...
                <div><h4>受干擾之情形</h4>
                    <p>在1m之後受干擾，反序低花特約即不適用。因此，本節討論的情形是1m-2m-(?)這個位置的干擾。</p>
                    <p>在1m-2m-(X)表示Takeout double時，除了表示稍微多餘的防禦力量外，其餘當作敵方沒有double進行。</p>
                    <p>在受到插叫以後，double是處罰，而其他自然叫牌。Cuebid表示稍微有多餘力量，但不必太強。</p>
                </div>
                <div><h4>1m-3m後續</h4>
                    這個情形下，幾乎只有對於18-19平均牌，開叫者可叫3NT。其他叫品皆為自然。
                </div>
            </div>
        </div>
        ...
        <div><h2>1NT開叫的後續</h2>
            ...
            <p>基本上，選擇時應該依據點力與牌形。當力量不到邀請點力時，僅在適合時可以轉換或透過制度「逃跑」至一個王牌合約，否則一律Pass 1NT。逃跑至王牌合約的方法最傳統即是透過2!D/2!H轉換至!H或!S，至於其他的方法即屬於較進階的方法。</p>
            <p>邀請力量的手牌，原則上力量是8-9點，可以選擇的合約較多。原則上，手持低花牌組時，叫牌以找尋3NT為目標。手持高花牌組時，以四線高花合約為目標，沒有配合時，再以3NT作為歸宿。</p>
            ...
            <div><h3>滿貫目標叫牌</h3>
                <table class="bidtable" id="1NT">
                    ...
                    <tr>
                        <td>4!C</td>
                        <td>Gerber問A。後續0/4, 1, 2, 3。</td>
                    </tr>
                    <tr>
                        <td>4NT</td>
                        <td>邀請小滿貫（參考範圍：16-17點）。Pass為不受邀，其他為受邀。之後叫出5線新花表示4張牌組，6線新花表示5張牌組。</td>
                    </tr>
                    <tr>
                        <td>5NT</td>
                        <td>迫叫6NT，邀請7NT。（參考範圍：21點）</td>
                    </tr>
                    <tr>
                        <td>6NT</td>
                        <td>束叫。（參考範圍：18-20點）</td>
                    </tr>
                    <tr>
                        <td>7NT</td>
                        <td>束叫。（參考範圍：22點以上）。</td>
                ...
                <p>除了先找尋王牌配合，再決定線位與是否有滿貫的叫牌方法外，還能夠直接計算點力決定滿貫。原則上，在一般的平均牌，有33點可以到小滿貫（六線合約），37點可以到大滿貫（七線合約）。</p>
            </div>
        </div>
        <div><h2>同伴竄叫以後</h2>
            <p>竄叫以後的原則是RONF（Raise: only not forcing），代表原則上只有加叫（和3NT）是不迫叫，其他叫品是迫叫叫品。RONF的叫品，主要是增強竄叫的效果，並非有實際上的力量，原則上3張配合以上可以加叫，每多一張王牌可加叫一線。</p>
            <p>至於實際有力量，要挑戰成局，則利用其他所有的叫品。這樣的力量，通常需要16點以上。若能直接決定合約，可以直接叫出。如果有5張以上牌組希望取得同伴支持，則可以簡單叫出。若同伴竄叫高花，自己有兩張以上支持，但不確定力量是否足夠，可使用2NT詢問同伴。</p>
            <table class="bidtable" id="2H">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="#OGUST">2NT!</a></td>
                        <td>OGUST，詢問叫。</td>
                    </tr>
                </tbody>
            </table>
            <p>OGUST詢問叫是利用整個三線，來區別力量和強度。</p>
            <table class="bidtable" id="OGUST">
                <thead>
                    <tr>
                        <th>2!D/!H/!S</th>
                        <th>2NT!</th>
        ...
        <div><h2>Negative Doubles</h2>
            ...
            <p>所謂的Negative double前面已經有敘述過，指的是答叫者的double。</p>
        </div>
        <div><h2>敵方開叫以後</h2>
